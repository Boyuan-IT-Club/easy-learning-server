...
/**
 * 官方课程的跨端稳定编号，对应 official_course_code；具体版本由 content_version 区分。
...
public @interface OfficialCourseCode {

    String message() default "OfficialCourseCode 必须为非空白字符串，且不超过 64 个字符";
